...
const Footer = () => {
    return (
        <footer className="p-4 bg-gradient-to-r from-gray-300 via-gray-100 to-pink-500 sm:p-6 dark:bg-gradient-to-r dark:from-gray-800 dark:via-gray-600 dark:to-pink-700">
...
<div className="flex mt-4 py-11 space-x-6 sm:justify-center sm:mt-0">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
                ...
                {/* <!-- <div>
                    ...
                    <ul className="text-gray-600 dark:text-gray-400">
                        <li className="mb-4">
                            <a href="https://github.com/themesberg/flowbite" className="   text-dark hover:underline ">Github</a>
                        </li>
                        <li>
                            <a href="https://discord.gg/4eeurUVvTy" className="   text-dark hover:underline">Discord</a>
                        </li>
                    </ul>
                </div> --> */}
                <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center  text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" className="hover:underline">Devloops™</a>. All Rights Reserved.
            </span>
